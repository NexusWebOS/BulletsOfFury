"""Check Stage 7–9 actual boss-death reward routes in Chromium."""
...
print(results)
expect = {7:'toxic',8:'prism',9:'water'}
assert all(r['defeated'] and r['drops']==[expect[r['stage']]] and (r['stage']==7 or r['dead']) for r in results), results
assert not errors, errors[:8]
print('PASS Stage 7–9 bosses each drop exactly one stage element; no browser errors')
