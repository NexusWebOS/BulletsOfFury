...
## 2026-09-15 Arcade route and campaign-isolation continuation

Main 7635330b installed. Read docs/ARCADE_ROUTES_0915.md and docs/ARCADE_ISOLATION_0915.md. Arcade skips map/outbound/pilot-ending routes, resumes earned Stage 5 bonus detours, and now receives Stage 7 solo/co-op results bonuses. Its Warden death keeps authored effects without story portal flight; Campaign retains its escape. Bonus/debug entry preserves campaign unlocks and pending arrival. Native24/24 plus earlier route20/20, no browser errors; nine main boss identities/HP match across four difficulties. Syntax passes; full suite 3851/57, exit1, no new names. Runtime LF and suite CRLF preserved. MODE-01 stays partial: pilot-specific dialogue (Stage 5 intro/Freezer), natural-play comparison, remaining co-op routes. Tally79 complete/8 partial/61 pending. No commit/push.

## 2026-09-15 Retina encounter-router audit
Read docs/RETINA_AUDIT_0915.md. The shared Retina list now follows and damages every authored live component family: Furnace phase plates, Genesis mechs, sectional rigs, Razorback phases, solo/dual Tempest apertures and hulls, quad-laser turrets, Blacksteel wings, Warden toxic canisters, Stage 4 nodes/helpers, Stage 6 nodes/bays, Xeno helpers and Stage 9 cores. Protected or transitional hulls never appear. Native Chromium 13/13 with actual Retina/missile keys and inspected pixels; suite section 304b 12/12. Complete suite 3862/58, exit 1, exact recorded 58-name baseline. ENG-06 complete. Checklist 148: 80 complete / 7 partial / 61 pending. No commit/push.

## 2026-09-15 shared same-element absorption
Read docs/ELEMENTAL_ABSORPTION_0915.md. Fire enemies retain 50% damage from fire attacks and ice enemies retain 50% from ice, across enemy/miniboss/boss damage boundaries. Popup text is throttled per target. Fire-Ice keeps its authored opposing-element response, and Stage 8's final boss remains exempt. Native Chromium combined pass 16/16 using actual held fire and inspected `FIRE DMG ABSORBED!` pixels. This pass also fixes the live `flameDraw` declaration-order crash exposed by the visual probe. Suite section 304c 10/10; full suite 3873/57, exit 1, no new baseline names. ENG-12 complete. Checklist 148: 81 complete / 7 partial / 60 pending. No commit/push.

Read docs/ELEMENTAL_WEAKNESS_0915.md. The shared damage boundary now applies exact 2x fire-on-ice and ice-on-fire damage through enemies, minibosses, bosses, authored part/helper routes and shield pools. Freezer's existing Stage-2 Ice Breath and Stage-3 Fire-Ice bonuses remain 2x rather than stacking to 4x. Opposing hits keep the authored red/light-blue silhouette and Stage 8's final boss exemption. Native Chromium combined pass 19/19 with actual held primary fire on an authored Stage-3 ice tank and inspected red-hit pixels. Suite section 304c 13/13; exact-runtime full suite 3875/58, exit 1, exact recorded failure-name baseline. ENG-13 complete. Checklist 148: 82 complete / 7 partial / 59 pending. No commit/push.

Read docs/ENEMY_SHIELD_STUN_0915.md. An ordinary enemy shield break now starts a shared 1.15-second movement/fire stun with a 14px lift, smooth rotation and exact anchor restoration. Four outward and three orbiting authored shield-impact plates show the dizzy state. Splash is clamped to 78-124px, 16 damage and six nearest ordinary enemies; tagged secondary breaks can stun but cannot chain splash. One-way shields enter existing frenzy only after the stun and do not repeat the break sound. Native Chromium 9/9 using actual held Freezer Ice Breath and inspected pixels. Suite section 304d 8/8; full suite 3884/57, exit 1, no new baseline names. ENG-11 complete. Checklist 148: 83 complete / 7 partial / 58 pending. No commit/push.

## 2026-09-15 Chrome Hammer one-hand boomerang

Read docs/CHROME_HAMMER_BOOMERANG_0915.md and docs/qa/hammer_boomerang_0915.json. The Stage-5 Chrome Hammer now alternates its warned leap with a committed vertical boomerang: a 1.55-second accelerating one-hand spin, 0.70-second outbound throw and visible magnetic return capped at 315 px/s. The weapon is dangerous on both legs and has distinct spin, release, magnet and catch sounds. Independent generated body/hammer layers avoid a duplicate attached weapon. Native Chromium captured 50 frames at 12 fps with both PNGs HTTP 200 and zero page/console errors; reviewed release, bottom turn and catch pixels. Focused section 304e 12/12; full suite 3897/57, exit 1, exact recorded failure-name baseline. SPACE-23 complete; checklist 149: 84 complete / 7 partial / 58 pending. SPACE-06 remains partial for full natural-play Stage-5 balance. No commit/push.

## 2026-09-15 Hard ordinary-enemy hull and shield health

Read docs/HARD_ENEMY_HP_0915.md and docs/qa/hard_enemy_hp_0915.json. MODE-04 complete: Hard ordinary-enemy hull scaling is exactly +15% over Normal at the shared shots-to-kill boundary in both Campaign and Arcade, replacing an older +35% value. Automatic shield energy derives from the scaled hull, so it receives the same increase. Bosses, minibosses and sectional encounters retain their explicit encounter scaling. Native Chromium shows the same Stage-5 frigate at Normal 12 hull / 4 shield and Hard 14 hull / 5 shield with zero page/console errors. Focused section 304f 6/6; full suite 3904/56, exit 1, no new failure name against the 57-name baseline. Checklist 149: 85 complete / 7 partial / 57 pending. No commit/push.

## 2026-09-15 Stage-2 thermal fodder durability and shields

Read docs/STAGE2_THERMAL_FODDER_0915.md and docs/qa/stage2_thermal_fodder_0915.json. S2-02 complete: all twelve volcanic combat hulls receive a 25% post-EHP durability lift plus weak one-way fire, hex or volt shields at 18-22% of the hull with a four-point minimum. Shield breaks preserve the hull hit and enter the shared splash, 1.15-second lift/rotation stun and frenzy handoff. Stage-2 props, bosses and minibosses are excluded. Native Chromium reviewed three representative authored hulls/families with zero bullets or browser errors. Focused section 304g 6/6; full suite 3909/57, exit 1, exact recorded failure-name baseline. Checklist 149: 86 complete / 7 partial / 56 pending. No commit/push.

## 2026-09-15 Stage-2 Hard encounter HP and fire absorption

Read docs/STAGE2_HARD_ENCOUNTERS_0915.md and docs/qa/stage2_hard_encounters_0915.json. S2-07 complete: the Stage-2 Hard encounter floor is exactly 1.25x Normal for the live Furnace Tyrant and Magma Ward. This corrects the floor clamp that turned the apparent table ratio into only about 10% in play. Both roles retain 50% same-element fire damage through the shared elemental gate and still take 2x opposing ice damage; Furious remains 1.30. Native Chromium shows Furnace Tyrant at Hard 3236 versus Normal 2589 with the actual FIRE DMG ABSORBED popup and zero browser errors. Focused section 304h 6/6; full suite 3916/56, exit 1, no new failure name against the 57-name baseline. Checklist 149: 87 complete / 7 partial / 55 pending. No commit/push.

## 2026-09-15 Shared no-one-shot enemy pools

Read docs/NO_ONE_SHOT_RULE_0915.md and docs/qa/no_one_shot_rule_0915.json. ENG-05 complete: fresh ordinary hulls, authored shields and destructible encounter components survive one lethal event at 1 HP/energy; later impacts or beam ticks can finish them. One-HP fodder becomes a real two-hit pool, and damage stats credit actual pool loss. Stage 4 wide piercing laser retains its approved dual-generator exception. Native Chromium 16 frames with inspected pixels and zero browser errors. Focused section 304i 14/14; confirmation suite 3931/56, exit 1, no new failure names against the 57-name baseline. Checklist 149: 88 complete / 7 partial / 54 pending. No commit/push.

## 2026-09-15 Manual missile tiers and caps

Read docs/MANUAL_MISSILE_TIERS_0915.md and docs/qa/manual_missile_tiers_0915.json. MSL-04 and MSL-05 complete: Standard/Super/Ultra/Uber manual missiles use exact 1/1.25/1.5625/1.953125 damage and visible size multipliers. Super/Ultra/Uber caps are 50/35/20 across pickups, firing, save/load, missile-rush restore and independent co-op state. Passive homing missiles remain unchanged. Native Chromium shows all four authored missiles, exact damage and caps with zero browser errors. Focused section 304j 18/18; suite 3949/56, exit 1, no new failure names against the 57-name baseline. Checklist 149: 90 complete / 7 partial / 52 pending. MSL-06 next. No commit/push.

## 2026-09-15 Manual missile upgrade lifecycle

Read docs/MISSILE_UPGRADE_LIFECYCLE_0915.md and docs/qa/missile_upgrade_lifecycle_0915.json. MSL-06/07 are partial: Standard upgrades immediately to Super; surviving the next authored wave makes Ultra eligible, and surviving the following wave makes Uber eligible. Death resets the equipped tier to Standard. Eligibility, wave serials and tier state persist in Campaign and remain independent per co-op seat. Ordinary-play upgrade boxes and their SpriteCook art remain MSL-08 work, so the lifecycle is not marked complete. Focused section 304j 30/30; suite 3960/57, exit 1; native 23 frames with zero browser errors. Checklist at that point: 90 complete / 9 partial / 50 pending. No commit/push.

## 2026-09-15 Persistent achievement registry

Read docs/ACHIEVEMENT_REGISTRY_0915.md and docs/qa/achievement_registry_0915.json. ACH-01/03/04/05/07/08/10/11 complete: one account/profile store owns 66 stable definitions, and the shared stage, encounter, weapon and run boundaries now award them. Stage clean rules cover co-op; Stage-1 speed tiers are exclusive; duplicate unlocks never score twice. ACH-06 is partial because its 1,000-point no-continue trigger works but the SpriteCook trophy avatar remains. Chromium trigger proof shows seven awards and exactly 1,630 points across 20 frames with zero browser errors. Focused 37/37; full suite 3998/56, exit 1, with no new failure names and the intermittent two-lance assertion absent. Checklist 149: 98 complete / 10 partial / 41 pending, 51 unfinished. No commit/push.
## 2026-09-15 Arcade natural-play parity

Read docs/ARCADE_NATURAL_PARITY_0915.md and docs/qa/arcade_natural_parity_0915.json. MODE-01 complete: real updatePlay/drawWorld Chromium runs consume every authored wave across Campaign and Arcade Stages 1-9, reach identical miniboss/boss identities, and co-op only repeats pressure from existing enemy families. Combined route evidence is 20/20 Arcade routes, 24/24 campaign isolation/Warden payouts, 14/14 Stage-5 dialogue and co-op results, and 64/64 natural encounters, all with zero browser errors. Syntax passes. Unchanged runtime full suite 3997/57, exit 1; 56 baseline names plus the headless Stage-1 sand-tank timing assertion, while the same runtime previously passed it and native Campaign/Arcade/co-op each consumed all 19 Stage-1 waves. Checklist 149: 99 complete / 9 partial / 41 pending, 50 unfinished. No commit/push.

## 2026-09-15 Shared non-laser warning repair

Read docs/SHARED_NONLASER_WARNING_0915.md and docs/qa/shared_nonlaser_warning_0915.json. ENG-02 remains partial. Jungle Overlord-X now uses the shared authored green/yellow/red FOV and overhead alert for its charge, locks during yellow and releases down the committed lane. Removed an unreachable generic ring whose `bossTelegraph` declaration was shadowed by the mech renderer; the mech function now has a distinct name and warnings use attack-owned simulation clocks. Native Chromium 12/12 with visually inspected phase/release frames and zero errors. Syntax passes; full suite 3999/56, exit 1, no new failure names. Checklist remains 149: 99 complete / 9 partial / 41 pending, 50 unfinished. No commit/push.

## 2026-09-15 locked Boss Rush and Time Attack cards

Read docs/LOCKED_MODES_0915.md and docs/qa/locked_modes_0915.json. ACH-12/13 complete: New Game now lists Campaign, Arcade, Co-op, Boss Rush and Time Attack. The two generated 16-bit mode plates render grayscale beneath the byte-identical Nexus II crossed-chain lock until a real final Campaign victory stores `bof_bonus_modes_v1`; Arcade and early-stage clears cannot unlock them. Confirmation while locked plays the blocked alert. Their playable routes remain ACH-14, so revealed cards state that development is in progress instead of entering unfinished content. ImageGen's baked checkerboard is excluded by a measured source crop and beveled runtime clip. Native Chromium 13/13 with inspected locked/revealed screens and zero page/console errors. Focused suite section 310 passes 15/15; full suite 4013/57, exit 1, exact recorded failure-name baseline. Checklist 149: 101 complete / 9 partial / 39 pending, 48 unfinished. No commit/push.

## 2026-09-15 Jungle Overlord-X gauge entrance

Read docs/OVERLORD_GAUGE_INTRO_0915.md and docs/qa/overlord_gauge_intro_0915.json. S1-10 complete: the Stage-1 helicopter approaches with its gauge hidden, fades the authored BOSS gauge in empty, fills it left-to-right across eight existing menu blips, holds the completed bar briefly, and only then enables damage, initializes combat AI and starts `boss1` music. The warning handoff stops stage music instead of starting boss music early; all other boss music routes remain unchanged. Native Chromium 15/15 with six inspected presentation frames and zero page/console errors. Focused suite section 311 passes 9/9; full suite 4023/56, exit 1, no new failure name. Checklist 149: 102 complete / 9 partial / 38 pending, 47 unfinished. No commit/push.

## 2026-09-15 Jungle Overlord-X dam flyover

Read docs/OVERLORD_FLYOVER_INTRO_0915.md and docs/qa/overlord_flyover_intro_0915.json. S1-09 complete: Overlord-X now starts below the dam, climbs through the player lane in 1.18 seconds with its full authored hull and rotor shadow layered over the player, then settles and executes a 0.48-second full whip spin before the empty boss gauge appears. Gauge, vulnerability, AI and boss music remain closed until the dependent S1-10 sequence completes. Native Chromium flyover 13/13 and gauge 15/15 with inspected frames and zero page/console errors. Focused sections 311 and 312 each pass 9/9. Full suite 4032/57, exit 1; all names match the established baseline and the intermittent Stage-1 sand-tank timing assertion failed this run. Checklist 149: 103 complete / 9 partial / 37 pending, 46 unfinished. No commit/push.

## 2026-09-15 Jungle Overlord-X eight-beat pass warning

Read docs/OVERLORD_EIGHT_BEAT_WARNING_0915.md and docs/qa/overlord_eight_beat_warning_0915.json. S1-12 complete: every Overlord-X charge now owns a 1.60-second, eight-beat Retina cadence. Each 0.20-second beat forces the authored lane and overhead alert red; the shared green/yellow progression remains between beats. The lane locks halfway through, the boss remains vulnerable throughout the shooting window, and the eighth beat releases a nontracking vertical charge. The shared one-shot alert is suppressed only for this cadence, preventing a ninth alarm. Native Chromium 14/14 plus shared-warning regression 12/12, with inspected frames and zero browser errors. Focused section 313 passes 10/10. Full suite 4042/57, exit 1; no new failure names and the intermittent Stage-1 sand-tank assertion failed this run. Checklist 149: 104 complete / 9 partial / 36 pending, 45 unfinished. No commit/push.

## 2026-09-15 Jungle Overlord-X four-pass frenzy

Read docs/OVERLORD_FOUR_PASS_FRENZY_0915.md and docs/qa/overlord_four_pass_frenzy_0915.json. S1-11 complete: the first below-half-health charge becomes four warned crossings over four distinct player-sampled lane bands, alternating south/north/south/north. Passes two and four alone rain authored orange machine rounds downward. Each leg turns the complete helicopter into its travel direction, goes fully off screen, receives the S1-12 eight-beat warning, and the fourth exits into the existing curved return. Native Chromium 16/16 with inspected frames, 32 counted beeps and zero browser errors. Focused section 314 passes 8/8. Full suite 4050/57, exit 1; no new failure names and the intermittent Stage-1 sand-tank assertion failed this run. Checklist 149: 105 complete / 9 partial / 35 pending, 44 unfinished. No commit/push.

## 2026-09-15 Furnace Tyrant accelerating rollerball

Read docs/FURNACE_ROLLERBALL_0915.md and docs/qa/furnace_rollerball_0915.json. S2-06 complete: the live Furnace core controller now warns and commits to one horizontal player lane, then accelerates through six whole-playfield crossings from slow to super-fast while its complete authored body/head plate spins progressively faster inside the real flame shield. The lane remains escapable by ordinary vertical movement and contact respects the existing roll/somersault invulnerability. It returns cleanly to the rotor attack. Native Chromium 14/14 with four inspected frames and zero errors. Focused section 315 passes 10/10. Full suite 4060/57, exit 1; every failure name matches the established baseline and the intermittent Stage-1 sand-tank assertion failed this run. Checklist 149: 106 complete / 9 partial / 34 pending, 43 unfinished. No commit/push.

## 2026-09-15 Frost Cruiser charged viewport sweep

Read docs/FROST_CRUISER_SWEEP_0915.md and docs/qa/frost_cruiser_sweep_0915.json. S3-06 complete: the Stage-3 Frost Cruiser now commits from the player's sampled side, charges for three seconds through the shared green/yellow/red FOV, darkens the arena under eleven authored lightning/crackle beats, then sweeps one dark-edged white-core beam monotonically across the complete viewport. Visual and collision width are both 52.5px, exactly 25% wider, and the attack disables before bounded recovery. Jungle Cruiser behavior remains unchanged. Native Chromium 16/16 with six inspected frames and zero browser errors. Focused section 316 passes 11/11. Full suite 4071/57, exit 1; every failure name matches the established baseline and the intermittent Stage-1 sand-tank assertion failed this run. Checklist 149: 107 complete / 9 partial / 33 pending, 42 unfinished. No commit/push.

## 2026-09-15 Frost Cruiser Retina spiral volley

Read docs/FROST_CRUISER_SPIRAL_VOLLEY_0915.md and docs/qa/frost_cruiser_spiral_0915.json. S3-08 complete: Hard and Furious replace the Frost Cruiser's opening missile burst with one 1.35-second player Retina charge and six independent rockets at 0.18-second intervals from alternating physical left/right pods. Each round has a distinct frame-time-independent spiral phase, remains shootable and belongs to the shared lock; a real player machine round destroys it. The authored pod lightning remains bright while the black/royal-blue hull stays readable. Normal retains its prior missile phase. Native Chromium 14/14 with four inspected frames and zero browser errors. Focused section 317 passes 15/15. Full suite 4086/57, exit 1; every failure name matches the established baseline and the intermittent Stage-1 sand-tank assertion failed this run. Checklist 149: 108 complete / 9 partial / 32 pending, 41 unfinished. No commit/push.

## 2026-09-15 Frost Cruiser Furious volley-charge combo

Read docs/FROST_CRUISER_FURIOUS_CHARGE_0915.md and docs/qa/frost_cruiser_furious_charge_0915.json. S3-09 complete: the first Furious below-25-percent enrage now follows its one-Retina six-rocket spiral volley with a 1.20-second shared green/yellow/red body-charge warning. It tracks the player until 0.86 seconds, commits for a final 0.34-second dodge window, rotates and dashes down that lane at 760 px/s, remains physically dangerous, exits fully and returns collision-safe from above at 260 px/s. Hard and later rage cycling remain unchanged. Native Chromium 16/16 with five inspected frames, a real dodge and a real hull hit; zero browser errors. Focused section 318 passes 10/10. Full suite 4096/57, exit 1; every failure name matches the established baseline and the intermittent Stage-1 sand-tank assertion failed this run. Checklist 149: 109 complete / 9 partial / 31 pending, 40 unfinished. No commit/push.

## 2026-09-15 Rime Wall Hard Retina laser balls

Read docs/RIME_WALL_HARD_LASER_BALLS_0915.md and docs/qa/stage3_hard_laser_balls_0915.json. S3-11 complete: below half health on Hard and Furious, the Rime Wall opens one Retina and releases two independently shootable two-HP laser balls from its physical left and right cannons. The pair uses the authored dark-blue Rime orb plate with a rigid silhouette and four-step additive pixel pulse, no missile exhaust, shared steering/commit behavior, roll or somersault lock break and clean offscreen culling. Normal and the Frost Cruiser miniboss remain excluded. Native Chromium 17/17 with five inspected frames and zero browser errors. Focused section 319 passes 12/12; full suite 4108/57, exit 1, exact established failure-name baseline. Checklist 149: 110 complete / 9 partial / 30 pending, 39 unfinished. No commit/push.

## 2026-09-15 Rime Wall Furious Simon-Says cannon feints

Read docs/RIME_WALL_FURIOUS_SIMON_0915.md and docs/qa/rime_furious_simon_0915.json. S3-13 complete: Furious uses five fast authored side-cannon FOV cues in the exact yellow/red/yellow/red/red-flash order, never green, with no overhead alert plate. Both mounts participate, only the final flashing cannon releases, and its dark-blue beam remains fixed to that committed lane. The same live-router trace found and repaired S3-11's unreachable historical calls; native `shipBossAttack` now opens the shared two-release Retina pair on Hard/Furious and excludes Normal. Native Chromium 21/21 with six inspected frames and zero errors. Focused section 320 passes 13/13; full suite 4122/56, exit 1, established baseline only. Checklist 149: 111 complete / 9 partial / 29 pending, 38 unfinished. No commit/push.

## 2026-09-15 Olive Warden Hard/Furious assault cycle

Read docs/OLIVE_WARDEN_HARD_ASSAULT_0915.md and docs/qa/olive_warden_hard_assault_0915.json. S4-06 complete: Hard/Furious now accelerate the Warden's side-turret spreads and dual center flurries, then flow through a continuous expanding orbit, horizontal firing glide, shared green/yellow/red lane warning, late lock and accelerating southbound body ram. The whole authored plate remains upright. After leaving the screen it follows a collision-safe cubic side return. Continuity measurement caught and removed a 63px circle-entry snap and a 30px warning-entry pull. Native Chromium 28/28 with nine inspected frames and zero errors. Focused section 321 passes 13/13; full suite records 57 failures, exit 1: 56 established baseline names plus the known intermittent Stage-1 sand-tank fixture. Checklist 149: 112 complete / 9 partial / 28 pending, 37 unfinished. No commit/push yet; Mike has now authorized committing and pushing the finished overnight batch.

## 2026-09-15 Hard/Furious difficulty elite aces

Read docs/DIFFICULTY_ELITE_ACES_0915.md and docs/qa/difficulty_elite_aces_0915.json. MODE-05 complete: all nine stages now add zero/one/two authored Expansion Vol. 1 aces on Normal/Hard/Furious. The Elite X controller supplies shield-first durability, predictive pursuit, incoming-fire rolls and aimed volleys; each stage has a deliberate authored primary palette and Furious secondary. A native pass exposed and fixed a cold-load race where a shield could appear before its hull by warming the exact `_idle` renderer key. Chromium 42/42 across every stage and difficulty, all nine screenshots inspected, zero errors. Focused section 322 passes 23/23. Checklist then reached 113 complete / 9 partial / 27 pending.

## 2026-09-15 Olive Warden difficulty escorts

Read docs/OLIVE_WARDEN_ESCORTS_0915.md and docs/qa/olive_warden_escorts_0915.json. S4-07 complete: Hard gets an authored Olive Carrier flank gunner plus a player-like missile protector; Furious gets the gunner and two protectors. The gunner owns a mounted rotary burst, protectors fly bounded approach/retreat legs and release shootable committed missiles, and every helper has independent shield/hull pools routed through the real miniboss hit test. Normal remains solo and the Stage-4 no-homing rule remains intact. Chromium 15/15 with two inspected formations and zero errors. Focused section 323 passes 14/14; full suite records the established 57 failures with no new names. Checklist 149: 114 complete / 9 partial / 26 pending, 35 unfinished. Mike authorized the final overnight commit and GitHub push.
...
## 2026-09-16 Stage-7 DUAL SCOOP DREDGER minefield warning
ENG-02 advances: the Stage-7 miniboss now commits one safe column before its late minefield, previews the five dangerous trajectories through the shared green/yellow/red system for 0.86 seconds, and only then releases the original five slow shootable mines. The old mine gate required a nonexistent third Dredger phase; it now runs every fourth attack in the real damaged phase. The opening cannot chase late movement. Focused section 343 passes 10/10, Chromium passes 16/16 with zero errors, and the full suite reaches 4,375 passes with the exact established 56-name failure baseline. ENG-02 remains partial. See docs/STAGE7_DREDGER_MINE_WARNING_0916.md.

## 2026-09-16 Stage-8 BLACK COCOON crescent-wall warning
ENG-02 advances: the opening Stage-8 Vile form now commits its original wide center corridor, previews all eleven dangerous crescent columns through a 0.72-second shared green/yellow/red warning, and only then releases the original authored crescents. Later boss-clock changes and player movement cannot relocate the opening. Focused section 344 passes 10/10, Chromium passes 16/16 with zero errors, and the full suite reaches 4,384 passes with the established 56 failures plus the intermittent Stage-1 sand-tank fixture. ENG-02 remains partial. See docs/STAGE8_VILE_CRESCENT_WALL_WARNING_0916.md.

## 2026-09-16 Stage-8 Vile aimed-fan warnings
ENG-02 advances: RAVENOUS ASCENDANT commits five needle trajectories through a 0.62-second shared green/yellow/red warning, and FURIOUS DEATH commits seven gunship trajectories through a 0.58-second warning. Both preserve their authored ordnance, speeds, alternating hardpoints, muzzles and total cooldowns. The second form's even-step homing pair keeps the shared Retina rule and queues its lock at warned-fan release. Focused section 345 passes 10/10, Chromium passes 23/23 with zero errors, and the full suite reaches 4,395 passes with the exact established 56-name failure baseline. ENG-02 remains partial. See docs/STAGE8_VILE_AIMED_FAN_WARNING_0916.md.
...
## 2026-09-16 Stage-6 Doomsday Carrier twin-cyclone warning
ENG-02 advances: the Doomsday Carrier Mk II commits the six original cyclone-tracer paths from its twin rotary batteries before a 0.62-second shared green/yellow/red warning. The field origins stay on their physical hardpoints while all six angles remain locked against late movement. Mirrored offsets, authored rounds, base speed, muzzles and phase cadences are preserved. Focused section 348 passes 10/10 and Chromium passes 16/16 with zero errors. The full suite reaches 4,421 passes and the established 56 failures plus the intermittent Stage-1 sand-tank fixture, with no new name. ENG-02 remains partial. See docs/STAGE6_CARRIER_CYCLONE_FAN_WARNING_0916.md.

## 2026-09-16 Stage-6 Doomsday Carrier storm-node warning
ENG-02 advances: both shield-down Carrier phases commit their alternating storm-node pair and six- or ten-lane fan before a 0.62-second shared green/yellow/red warning. Warning origins follow the live node positions while aim and parity stay committed. Destroying a warned node disarms only its lanes; phase transitions clear stale fan warnings. Original offsets, speed 3.15, phase cadences and the central prism-lance beat are preserved. Focused section 349 passes 11/11, Chromium passes 16/16 with zero errors, and the full suite reaches 4,432 passes with the established 56 failures plus the intermittent Stage-1 sand-tank fixture. ENG-02 remains partial. See docs/STAGE6_CARRIER_NODE_FAN_WARNING_0916.md.

## 2026-09-16 Stage-6 Doomsday Carrier prism-crossfire warning
ENG-02 advances: Phase 5 commits all four upper-barrel prism paths before a 0.62-second shared green/yellow/red warning. Origins follow the moving hull while both alternating angle layouts remain fixed. Authored `s6prism` rounds, speed 4.3, muzzle reels, cannon sound and the 1.25-second total cadence are preserved; phase transitions clear stale crossfire warnings. Focused section 350 passes 12/12, Chromium passes 16/16 with zero errors, and the full suite reaches 4,443 passes with the established 56 failures plus the previously documented intermittent Stage-1 sand-tank and road-tank fixtures. ENG-02 remains partial. See docs/STAGE6_CARRIER_PRISM_CROSSFIRE_WARNING_0916.md.

## 2026-09-16 Stage-6 Doomsday Carrier gravity-mine warning
ENG-02 advances: Phase 5 commits its paired gravity-mine paths before a 0.72-second shared green/yellow/red warning. Warning origins follow the moving left and right mounts while both crossing angles stay locked. Authored `s6gravity` art, base speed 1.35, acceleration 0.16, maximum speed 2.15, scale 1.05, muzzles, sound route and the 1.72-second total cadence are preserved; phase transitions clear stale mine warnings. Focused section 351 passes 11/11, Chromium passes 16/16 with zero errors, and the full suite reaches 4,455 passes with the established 56 failures plus the intermittent Stage-1 sand-tank fixture. ENG-02 remains partial. See docs/STAGE6_CARRIER_GRAVITY_MINE_WARNING_0916.md.

## 2026-09-16 Stage-6 Doomsday Carrier Last Run slide repair
The Carrier's sixth-phase sine traverse now runs before all attack-controller, cannon/beam and cooldown returns. The complete authored plate and its live hardpoints/effects therefore move every gameplay frame instead of stepping only when a fresh attack beat passed the cooldown gate. The original 0.85 motion rate, bounded amplitude and attack cadence are unchanged, and earlier phases remain scoped out. Focused section 352 passes 7/7, Chromium passes 12/12 with zero errors, and the full suite reaches 4,463 passes with the exact established 56-name failure baseline. Tally remains 128 complete / 7 partial / 16 pending. See docs/STAGE6_CARRIER_LAST_RUN_SLIDE_0916.md.

## 2026-09-16 Stage-6 Doomsday Carrier omega-bomb warning
ENG-02 advances: both Last Run omega-bomb variants commit their center corridor before a 0.66-second shared green/yellow/red warning. Its origin follows the continuously sliding center cannon while the downward angle remains locked. Authored `s6omega` art, base speeds 1.1/1.25, acceleration 1.05, maximum speed 5.2, scale 1.15, muzzle, sound route and 1.45/1.20-second total cadences are preserved; phase transitions clear pending omega warnings. Focused section 353 passes 11/11, Chromium passes 16/16 with zero errors, and the full suite reaches 4,473 passes with the established 56 failures plus the intermittent Stage-1 sand-tank fixture. ENG-02 remains partial. See docs/STAGE6_CARRIER_OMEGA_WARNING_0916.md.

## 2026-09-16 Stage-6 Doomsday Carrier mirrored cluster-fan warning
ENG-02 advances: the Last Run cluster fan commits all six original mirrored paths before a 0.62-second shared green/yellow/red warning. Origins follow the continuously sliding left and right mounts while the three angles per side remain locked and the center escape wedge stays open. Authored `s6cluster` bomblets, speed 3.35, twin cyclone muzzles, single release cue and the 1.18-second total cadence are preserved; phase transitions clear pending cluster warnings. Focused section 354 passes 11/11, Chromium passes 16/16 with zero errors, and the full suite reaches 4,484 passes with the established 56 failures plus the intermittent Stage-1 sand-tank fixture. ENG-02 remains partial. See docs/STAGE6_CARRIER_CLUSTER_WARNING_0916.md.

## 2026-09-16 Stage-6 Doomsday Carrier chrome-flak warning
ENG-02 advances: the Last Run chrome-flak pair commits both shell paths before a 0.62-second shared green/yellow/red warning. Origins follow the continuously sliding lower-inner hardpoints while both angles stay locked. The old `%4` selector made the outer `-18°/+18°` pair unreachable; it now alternates with the inner `+10°/-10°` pair. Authored `s6flak` shells and burst reel, speed 3.75, 0.64-second fuse, five fragments per shell, twin muzzles and the 1.08-second total cadence are preserved; phase transitions clear pending flak warnings. Focused section 355 passes 13/13, Chromium passes 19/19 with zero errors, and the full suite reaches 4,497 passes with the established 56 failures plus the intermittent Stage-1 sand-tank fixture. ENG-02 remains partial. See docs/STAGE6_CARRIER_FLAK_WARNING_0916.md.

## 2026-09-16 Stage-7 Toxic Portal Warden cripple-rail warning
ENG-02 advances: the Warden's cripple phase commits a complete rail group before a 0.58-second shared green/yellow/red warning. Four fields preview three alternating straight singles and the paired offset finisher. Their origins follow the crawling hull while their committed angles stay fixed. The original rail-spears, three `5.25`-speed singles, dual `4.65`-speed finisher, `-0.07/+0.07` offsets, muzzles and sound remain intact; phase transitions clear pending warnings. Focused section 356 passes 13/13, Chromium passes 18/18 with zero errors, and the full suite reaches 4,510 passes with the established 56 failures plus the intermittent Stage-1 sand-tank fixture. ENG-02 remains partial. See docs/STAGE7_WARDEN_CRIPPLE_RAIL_WARNING_0916.md.
...
## 0917 - enemy AI: the evade and the denial, both per difficulty, both leaving NORMAL alone

`EVADE_DIFF` gives ordinary air units the incoming-fire read the droids and aces already had (`enemyEvadeTick`, from the one enemy loop); `BOSS_DENY_DIFF` makes the ship-boss denial patterns pick AGAINST the player's lane (`bossDenies()` / `playerLane(n)` in `shipBossAttack`: ember doorway opposite, lance safe lane never the player's, siege bank on the player's half). Both tables are zero on EASY and NORMAL and are checked by section 366 with the other per-difficulty tables. `docs/ENEMY_EVADE_0917.md`, section 369, probes 11/0 and 8/0.
- **A SIDESTEP THAT A PATTERN RE-ASSERTS IS A JITTER THAT NETS TO ZERO WHILE THE FLAG SAYS IT EVADED.** `jetTick` writes `e.x` in five places, so the probe measures the displacement THROUGH the live loop a frame at a time and demands monotonic; measured on seven unit classes across stages 1/2/4/6, all keep it (-20 to -33px over 14 frames).
- **THE PATTERN THE ROW NAMES IS NOT ALWAYS THE PATTERN IT FIRES.** Blacksteel's row says `pat:'lance'` and its first phase fires `stormbolts` (`pats:['stormbolts','lance']`); every volley the probe read was the wrong pattern and looked like the denial doing nothing. Drop the hp to reach the phase.
- **A VELOCITY FILTER ON `eBullets` CANNOT IDENTIFY A PATTERN'S ROUNDS** - `_shipShot` scales by `DIFF.ebSpeed` before the round lands, so the filter matched zero and every lane read "safe". Wrap `_shipShot` and count what the pattern ASKED for.

## 0917 - the giant beam, the sonic wave, the water orb

Three more of Mike's named combinations, all riding the infusion system rather than new weapons: KINETIC on the laser widens `beam.w` x1.5/x2.0/x2.5 (the draw and the hit test both read `beam.w`, so the wider column burns a wider lane - `probe_giantbeam_0917.py` 9/0, including a unit 38px off centre missed by the plain beam and burned by the giant one); KINETIC level 3 on the mg/spread releases Cole's own `sonicRelease(0.45)` every 24th ROUND, counted at the stamp site so the cadence is the gun's and not the wall clock; the orb and its shards are carriers and an infused orb is the authored 0825 ice wheel through `xartPalette` (`probe_infusion_carriers_0917.py` 10/0). `docs/INFUSIONS_0917.md` §7.
- **THE ENEMY DRAW-ERROR CATCH SWALLOWS A REFERENCE ERROR PER FRAME** (again): count errors in every probe.
- **A PROBE'S OFFSET MUST CLEAR THE UNIT'S OWN HALF-WIDTH** - "24px off centre" was inside the plain beam's reach (11 + the drone's 14.5) and read as a false hit; the geometry is in the assertion text now.
- **A SUITE RUN STARTED BEFORE A PATCH TESTS THE OLD game.js WITH THE NEW .cjs** - the vm loads the game once at start and requires each section later, so a pin added mid-run fails on code it never saw. Read the timeline before chasing.
