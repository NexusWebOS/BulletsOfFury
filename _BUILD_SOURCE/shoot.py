...
def main():
    ...
    print('state=%s  frames=%d  stageTimer=%.2f  enemies=%d  ebullets=%d  bossBullets=%d  bossFamilies=%s  subMuzzle=%s' %
          (info['state'], info['frames'], info['stageTimer'], info['enemies'], info['ebullets'], info['bossBullets'],
