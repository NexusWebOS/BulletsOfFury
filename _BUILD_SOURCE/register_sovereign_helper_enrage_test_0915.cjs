...
const line="require('./test_sovereign_helper_enrage_0915.cjs')(vm,ctxv,ok);",anchor="require('./test_sovereign_helper_blockade_0915.cjs')(vm,ctxv,ok);";
...
fs.writeFileSync(p,s,'utf8');console.log('REGISTERED_SOVEREIGN_HELPER_ENRAGE_TEST_0915');
