...
Just verified: Stage-8 BLACK COCOON committed eleven-column crescent-wall warning with the original wide safe corridor [Proof](STAGE8_VILE_CRESCENT_WALL_WARNING_0916.md).
